...
export function Contact() {
  return (
    <section
      id="contact"
      className="py-16 print:hidden sm:py-20"
    ...
    >
      <div className="mx-auto max-w-5xl px-5 sm:px-8">
        ...
        <button
          ...
          className="mt-5 inline-flex items-center gap-2 rounded-md border border-accent/50 px-5 py-2.5 text-sm text-accent transition-colors hover:bg-accent/10"
        >
          PDF로 저장
        </button>
      </div>
